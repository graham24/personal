...
const App = () => {
  return (
    <div
      id="main-content"
      className="dark:text-white bg-gray-100 dark:bg-gray-800 grid grid-cols-1 md:grid-cols-medium lg:grid-cols-large xl:grid-cols-xl min-h-screen max-w-screen"
    >
      <BrowserRouter>
        <Header />
